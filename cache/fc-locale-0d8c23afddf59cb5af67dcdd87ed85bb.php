...
<a href="{$contextUrl}">{$contextName}</a>',
  'default.journalSettings.lockssLicense' => '
revista utiliza el sistema LOCKSS para crear un sistema de archivo "
entre bibliotecas colaboradoras, a las que permite crear "
permanentes de la revista con fines de conservación y "
<a href="https://lockss.org/">Más...</a>"',
);
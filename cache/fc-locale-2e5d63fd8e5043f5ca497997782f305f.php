...
de portada no válido. Formatos aceptados: .gif, .jpg, o .png."',
  'editor.issues.hideCoverPageArchives' => '
mostrar la miniatura de la imagen de portada en la lista de números."',
  ...
  'editor.article.hideCoverPageToc' => '
mostrar la miniatura de la imagen de portada en la tabla de contenidos."',
  'editor.article.hideCoverPageAbstract' => '
mostrar la imagen de portada en la vista de resúmenes de artículos."',
);